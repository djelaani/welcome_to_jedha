...
On prendra comme exemples dans cette partie deux jeux de données communément utilisés pour illustrer les notions de modélisation que nous verrons dans ce qui suit. Il s’agit d’une série de concentration ce CO2 dans l’air, mesurée par un observatoire, l’autre série mesure la différentiel de pression atmosphérique au niveau de la mer entre deux points de la planète : [tahiti et les îles Darwin](https://www.itl.nist.gov/div898/handbook/datasets/MLCO2MON.DAT https://www.itl.nist.gov/div898/handbook/datasets/ELNINO.DAT)

[Jedha](https://www.itl.nist.gov/div898/handbook/datasets/MLCO2MON.DAT) et [jedha2](https://www.itl.nist.gov/div898/handbook/datasets/ELNINO.DAT)
